%$Header: /cvsroot/esrg/sfesrg/esrgpcpj/hyreach/doc/hyreachm/s_bib0/s_bib0.tex,v 1.8 2002/01/29 18:47:17 dtashley Exp $
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%$Log: s_bib0.tex,v $
%Revision 1.8  2002/01/29 18:47:17  dtashley
%Safety checkin before taking work home.
%
%Revision 1.7  2002/01/29 17:04:00  dtashley
%Version control info added, and minor edits.
%
%Revision 1.6  2001/10/25 05:32:40  dtashley
%Evening safety checkin after edits.
%
%Revision 1.5  2001/10/12 22:32:30  dtashley
%Substantial edits.
%
%Revision 1.4  2001/10/02 03:16:54  dtashley
%Final edits evening of 10/01/01.
%
%Revision 1.3  2001/10/02 02:12:42  dtashley
%Addition of batch file, edits.
%
